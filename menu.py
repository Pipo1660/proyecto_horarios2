...
class menu1:
    ...
    def crear(self,tk,sql,cursor,tipoCuenta,nombreCuenta,cerrarSesion,menuFunc):
        ...
        self.imagen_administrar_boletin = ImageTk.PhotoImage(Image.open("imagenes/administrar_boletin.png").resize((20, 20), Image.LANCZOS))
        self.imagen_administrar_horario = ImageTk.PhotoImage(Image.open("imagenes/administrar_horario.png").resize((20, 20), Image.LANCZOS))
        self.imagen_administrar_asistencia = ImageTk.PhotoImage(Image.open("imagenes/administrador_de_asistencia.png").resize((20, 20), Image.LANCZOS))
        self.imagen_administrar_alumnos = ImageTk.PhotoImage(Image.open("imagenes/administrar_alumnos.png").resize((25, 25), Image.LANCZOS))
        self.imagen_administrar_cuentas = ImageTk.PhotoImage(Image.open("imagenes/administrar_cuentas.png").resize((20, 20), Image.LANCZOS))
        self.imagen_materia = ImageTk.PhotoImage(Image.open("imagenes/materia.png.jpg").resize((25, 25), Image.LANCZOS))
        self.imagen_cerrar_sesion = ImageTk.PhotoImage(Image.open("imagenes/cerrar_sesion.png").resize((20, 20),Image.LANCZOS))
        self.imagen_aula = ImageTk.PhotoImage(Image.open("imagenes/aulas.png").resize((20, 20), Image.LANCZOS))                          
        self.imagen_filtro = ImageTk.PhotoImage(Image.open("imagenes/filtrar.png").resize((20, 20), Image.LANCZOS))
